export default [
  {
    act: "翻译：中译英 (列出参考)",
    prompt:
      "Please translate the following sentence to English with academic writing, and provide some related authoritative examples:\n",
  },
  {
    act: "翻译：中译英",
    prompt:
      "Please translate the following sentence to English with academic writing:\n",
  },
  {
    act: "翻译：中译英 (long command, 列出参考)",
    prompt:
      "Please translate the following sentence to English with academic writing, improve the spelling, grammar, clarity, concision, and overall readability. When necessary, rewrite the whole sentence. Further, provide some related authoritative academic examples:\n",
  },
  {
    act: "翻译：充当英翻中",
    prompt:
  ...
  },
  {
    ...
    prompt:
      "Below is a paragraph from an academic paper. Polish the writing to meet the academic style, and improve the spelling, grammar, clarity, concision, and overall readability. When necessary, rewrite the whole sentence. Furthermore, list all modifications and explain the reasons to do so in markdown table:\n",
  },
  {
    act: "修改：学术英语polish",
    prompt:
      "Below is a paragraph from an academic paper. Polish the writing to meet the academic style, and improve the spelling, grammar, clarity, concision, and overall readability. When necessary, rewrite the whole sentence:\n",
  },
  {
    act: "修改：中文 polish",
    prompt:
